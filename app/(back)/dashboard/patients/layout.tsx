...
//   const doc:DoctorDetail=await getData(`doctor/${user?.id}`)
  ...
  return (
    ...
    <div className="grid grid-cols-12">
      ...
      <PanelHeader title={"Patientes"} desc={uniqueUserAppointments.length.toString().padStart(2,"0")} icon={Calendar} />
      <div className="py-3">
      <PatientListPanel appointments={uniqueUserAppointments} link='/dashboard/patients/view' title='patient' />
      </div>
