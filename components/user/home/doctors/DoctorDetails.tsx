...
<div className="">
<Link className='rounded-md bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 duration-300 flex gap-4 overflow-hidden' href={`/service/${doctor.service.slug}`}>
      <Image src={doctor.service.imageUrl} alt='' width={1170} height={848} className='w-1/3 object-cover aspect-video' />
